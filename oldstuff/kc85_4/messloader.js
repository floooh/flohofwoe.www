...
var gamename = '';
var game_file = 'GAME_FILE';
var bios_filenames = 'kc85_4.zip'.split(' ');
var bios_files = {};
...
var Module = {
	'arguments': ["kc85_4","-verbose","-rompath",".","-window","-resolution","640x512","-nokeepaspect"],
    preRun: [],
    postRun: [],	
    print: (function() {
